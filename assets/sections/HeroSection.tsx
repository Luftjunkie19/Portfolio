...
function HeroSection() {
  ...
  return (
    <div className={`${classes.spaceBg}`}>
      ...
      <div className={`flex lg:h-[50vh] sm:flex-col-reverse lg:flex-row py-4 gap-12 lg:max-w-7xl lg:items-center px-2 sm:jutify-center lg:justify-between lg:my-0 lg:mx-auto`}>
          ...
          <motion.div variants={variants} initial={'outview'} whileInView={'inview'} viewport={{once:true}} animate className={`w-80 h-80 sm:self-center md:self-start lg:self-center relative top-0 left-0`}>
